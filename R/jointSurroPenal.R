...
#'
#' {\figure{surromodel1.png}{options: width="731"}}
#'
#' where,
...
#' becomes:
#'
#' {\figure{jointsurromed.png}{options: width="731"}}
#'
...
#'
#' {\figure{surromodel3.png}{options: width="731"}}
#'
#'
...
#'
#' {\figure{pte.png}{options: width="365"}}
#'

...
!========================          FUNCPA_CPM_TPS          ====================
    double precision function funcpasgenadditifalternatif_tps(b,np,id,thi,jd,thj,k0)
...
! *** NOUVELLLE DECLARATION F90 :
    ...
    double precision,external::risqindiv_additifalternatif
...
!cccccccccccccccccccccc
            if(c(i).eq.1)then
                res2(g(i)) = res2(g(i)) + dlog(risqindiv_additifalternatif(t1(i),i,bh,np))
            endif

            if ((res2(g(i)).ne.res2(g(i))).or.(abs(res2(g(i))).ge. 1.d30)) then
                !print*,"cox here"
                funcpasgenadditifalternatif_tps=-1.d9
                goto 123
            end if
...
!!cccccccccccccccccccccc
            call integration(risqindiv_additifalternatif,0.d0,t1(i),result,abserr,resabs,resasc,i,bh,np)
...
!cccccccccccccccccccccc
            if(c(i).eq.1)then
                !print*,t1(i),risqindiv_additifalternatif(t1(i),i,bh,np)
                res2(g(i)) = res2(g(i)) + dlog(risqindiv_additifalternatif(t1(i),i,bh,np))
            endif
...
!!cccccccccccccccccccccc
            call integration(risqindiv_additifalternatif,0.d0,t0(i),result3,abserr,resabs,resasc,i,bh,np)
...
!cccc nouvelle vraisemblance :ccccccccccccccccccccccccccccccccccccccccccccccc
    ...
    funcpasgenadditifalternatif_tps = res
...
123     continue
    ...
    end function funcpasgenadditifalternatif_tps

!====================================================================
!====================================================================
    double precision function risqindiv_additifalternatif(tps,i,bh,np)
...
!============ fonction de risque
    ...
    risqindiv_additifalternatif = bbb+vet

    return

    end function risqindiv_additifalternatif

...
F77_SUB(joint_longi)(const int *vectnsujet, const int *ngnzag, double *k0,
                     ...
                     int *params_hazard, int *counts,int *ier_istop, double *paraweib, 
                     double *martingales, double *reslongi,double *pred_y0, const int *glmlog0, 
                     const int *positionvartime,const int *numinterac, double *linearpred, double *linearpreddc,
                     double *ziout, const int *paratps, double *betamattps, double *eps, const int *gh,
                     const double *pagh, double *med, int *varcenters, int *vartreatment,
                     int *param_res_rt, double *res_rt);
